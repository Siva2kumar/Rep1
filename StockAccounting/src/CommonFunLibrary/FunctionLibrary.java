...
public class FunctionLibrary {
	...
	public static WebDriver startBrowser(WebDriver driver) throws Throwable
	{
		...
		{
			System.setProperty("webdriver.chrome.driver", "C:\\Users\\Sivakumar.y\\Downloads\\chromedriver.exe");
	...
	//OpenApplication
		...
		//scroll down page
				...
				public static void captureData(WebDriver driver ,String Locator_Type,String Locator_Value) throws Throwable 
				{
					...
					FileWriter fw=new FileWriter("C:\\Users\\Sivakumar.y\\StockAccounting\\CaptureData\\Data.txt");
				...
				public static void tableValidation(WebDriver driver,String column) throws Throwable
				{
					...
					FileReader fr=new FileReader("C:\\Users\\Sivakumar.y\\StockAccounting\\CaptureData\\Data.txt");
